module.exports = {
	...
	sideMenuClick: function(_e){
		try{
			...
			CloudClock.dispatcher.route(
				CloudClock.sideMenu.global,//parent window
				CloudClock.sideMenu.container,//main container within the window
				this.viewToLoad,//view to open
				CloudClock.sideMenu.currentView,//view to close
				CloudClock.sideMenu.data, //data
				false //extra params
			);
			
			// if this is the manager options side menu, make the sidebar hide
			if(CloudClock.sideMenu.global === 'managerOptions' && this.viewToLoad === "managerOptions_reports"){
				CloudClock.sideMenu.hideSidebar();
			}
