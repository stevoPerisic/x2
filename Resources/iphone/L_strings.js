...
exports.strings = function(text) {
    try {
        ...
        if ("en-us" === language || "en_us" === language || "en-US" === language || !language || "undefined" === language) return en_strings[text];
        if ("es" === language) return es_strings[text];
        if ("fr" === language) return fr_strings[text];
    } catch (error) {
