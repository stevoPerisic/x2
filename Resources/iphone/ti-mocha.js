(function() {
    ...
    function createConsoleLogger(type) {
        console[type] = function() {
            var util = require("titanium/util"), args = Array.prototype.slice.call(arguments, 0), rawArgs = args.slice(0), isStudio = /\-studio$/.test(mocha._ti_reporter);
            if (!mocha._ti_quiet) {
            ...
            mocha._ti_output_file && mocha._ti_output_file.append(util.format.apply(this, rawArgs).replace(/\x1B\[[0-9;]*[a-zA-Z]/g, ""));
        };
    }
    require.modules = {};
    ...
    require.register("runner.js", function(module, exports, require) {
        ...
        function extraGlobals() {
            if ("object" == typeof process && "string" == typeof process.version) {
                var nodeVersion = process.version.split(".").reduce(function(a, v) {
                    return a << 8 | v;
                });
                if (2315 > nodeVersion) return [ "errno" ];
            }
            return [];
        }
